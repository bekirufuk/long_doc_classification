...
from src.utils.attention_mapper import get_attention_mask
...
if __name__ == '__main__':
    ...
    for epoch in range(finetune_config['epochs']):
        for batch_id, batch in enumerate(train_dataloader):
            ...
            custom_attention_mask, custom_global_attention_mask = get_attention_mask(tfidf_sparse[tfidf_range_start:tfidf_range_end], f_names, batch['input_ids'], device)
            ...
            if is_log_step:
                outputs = model(batch['input_ids'], 
                            ...
                            global_attention_mask=custom_global_attention_mask
                            )
